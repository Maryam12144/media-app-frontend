...
import { sendOtp } from "../reducer/Actions";
...
const PinCode = (props) => {
  ...
  let { otpResponse, sendOtp } = props;

  useEffect(() => {}, [otpResponse]);

  const onFinish = (values) => {
    sendOtp(values).then(() => navigate("/reset-password"));
  };
...
export default connect(mapStateToProps, { sendOtp })(PinCode);
